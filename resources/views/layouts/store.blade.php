...
<body class="">
                    ...
                    <div class="col-lg-6 col-md-4 col-sm-6 col-xs-12 ">
                        <div class="header__actions">
                            @auth
                                ...
                                <a href="{{ route('logout') }}" onclick="event.preventDefault(); $('#logout').submit();"> Log Out</a>
    ...
    <script type="text/javascript" src="{{ asset('assets/store/plugins/revolution/js/extensions/revolution.extension.slideanims.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('assets/store/plugins/revolution/js/extensions/revolution.extension.layeranimation.min.js') }}">
    </script>
    <script type="text/javascript" src="{{ asset('assets/store/plugins/revolution/js/extensions/revolution.extension.navigation.min.js') }}">
    </script>
